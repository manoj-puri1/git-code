...
Step: 1.
Configuration git on terminal:
commands..
git config --global user.name".....name...." // add username of github user
git congig --global user.email"....email...' // add useremail of github user
git congif --list  // to see email and username.
